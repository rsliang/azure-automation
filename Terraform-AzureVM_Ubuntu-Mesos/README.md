...
Output:
C:\MyWork\TE\Clients\Amperity\TestLabs\Terraform>terraform init
...
Output:
C:\MyWork\TE\Clients\Amperity\TestLabs\Terraform>terraform plan
...
Output:
C:\MyWork\TE\Clients\Amperity\TestLabs\Terraform>terraform apply
...
4) Obtain the public IP address of your VM with az vm show
$ az vm show --resource-group myResourceGroup --name myVM -d --query [publicIps] --o tsv

Output:
C:\MyWork\TE\Clients\Amperity\TestLabs\Terraform>az vm show --resource-group myResourceGroup --name myVM -d --query [publicIps] --o tsv
52.179.14.5
...
Output (Git Bash CLI):
rilian@RLIANGSB MINGW64 /c/MyWork/TE/Clients/Amperity/TestLabs/Terraform
$ ssh azureuser@52.{...}.14.5
The authenticity of host '52.179.14.5 (52.{...}.14.5)' can't be established.
ECDSA key fingerprint is SHA256:zmlIsQ85hs8HTOe2hT39Tu7Dw0oYQWF8zyhfYRci6Fg.
Are you sure you want to continue connecting (yes/no)? y
Please type 'yes' or 'no': yes
Warning: Permanently added '52.179.14.5' (ECDSA) to the list of known hosts.
...
Install Mesos on Linux Ubuntu 16.04:

Downloading Mesos
1) Download latest stable release from Apache
...
2) Clone the Mesos git repository
